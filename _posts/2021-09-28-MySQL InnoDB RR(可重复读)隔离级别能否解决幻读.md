...
<img src="img/QQ20210928-142602.png" style="zoom:80%;" />

这个回答就是采用的争议点2 (`MySQL文档一致性非阻塞读`中也有提到) 就不再多解释了. 但这种是否应该视为幻读? 

<img src="img/QQ20210928-142933.png" style="zoom:80%;" />
...
如果前面这些内容都有了了解, 那看到这里, 去争论MySQL InnoDB RR隔离级别是否存在幻读已经不重要了, 毕竟基于一个不完整的规范, 再去争论也没有什么意义...
